...
func TestCharacterAffiliationNotModifiedUsesCachedAffiliationPublicClient(t *testing.T) {
	t.Parallel()
	...
	client := NewESIPublicClient("test-agent")
	client.client = goesi.NewESIClientWithOptions(httpClient, goesi.ClientOptions{
